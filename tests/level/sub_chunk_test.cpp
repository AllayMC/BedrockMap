...
TEST(SubChunk, BasicRead) {
    auto data = bl::utils::read_file(R"(C:\Users\xhy\dev\bedrock-level\data\dumps\sub_chunks\0_-1_0.subchunk)");
...
TEST(SubChunk, LayerFree) {
    ...
    auto  data = bl::utils::read_file(R"(C:\Users\xhy\dev\bedrock-level\data\dumps\bes\-1_-1.blockentity.palette)");
