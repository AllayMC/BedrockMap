...
public:
    ...
    inline std::
        unordered_map<std::string, std::array<bl::palette::compound_tag*, 4>>&
        data() {
        return this->data_;
    }
...
private:
    std::unordered_map<std::string, std::array<bl::palette::compound_tag*, 4>>
        data_;
};
...
public:
    ...
    inline const std::unordered_map<std::string, bl::palette::compound_tag*>&
    data() const {
        return this->data_;
    };
    ~general_kv_nbts();
