...
struct cfg {
    ...
    static constexpr uint8_t RW = 8u;  //(1<<w) //The size of region d. A region consists of RW * RW blocks, and the block coordinates are aligned to multiples of 8.
    ...
    static bool LOAD_GLOBAL_DATA;        // Whether to load global data such as villages
